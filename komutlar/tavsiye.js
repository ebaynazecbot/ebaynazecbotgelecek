...
exports.run = function(client, message, args) {
    ...
    var ac = client.emojis.get;
  var ka = client.emojis.get;
...
client.users.get('565536682946985999').send(embed2);
client.channels.get('805814704433397810').send(embed2).then(m => m.react(ac,
m.react(ka)))
