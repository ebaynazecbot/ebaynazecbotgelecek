...
exports.run = async(client, message, args) => { 
  ...
  if(user.id === message.author.id) return message.reply(':x: Kendine para göndermezsin!').then(çalanlara_selam => çalanlara_selam.delete(10000))
  ...
  if(miktar < 1)  return message.reply(':x: En az 1 gönderebilirsin.').then(çalanlara_selam => çalanlara_selam.delete(10000))
