...
exports.run = (client, message) => {
  ...
  weather.find({search: args.join(" "), degreeType: 'C'}, function(err, result) {
    ...
    if (result === undefined || result.length === 0) {
      message.channel.send('<a:carp:803486836890402846> **İşlem başarısız oldu!** <a:carp:803486836890402846> \n **Sebep:** Şehri belirtin veya böyle bir şehir yok! \n **Olası Çözüm/Çözümler:** !havadurumu Ankara yazmayı deneyiniz.')
      return;
  }
