...
exports.run = async (bot, msg, args) => {
        ...
        .addField(`Roller:`, `${msg.guild.members.get(user.id).roles.filter(r => r.name !== "@everyone").map(r => r).join(' **|** ') || "**Bu kullanıcıda hiçbir rol bulunmuyor**"}`, true)
        .addField(`Son gönderdiği mesaj:`, userinfo.sonmesaj, true)
        .setFooter(`EBAYNAZEC || Kullanıcı Sistemi`)
